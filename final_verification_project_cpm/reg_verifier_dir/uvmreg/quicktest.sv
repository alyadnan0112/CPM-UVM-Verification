...
// User register sequence
	...
	class qt_test extends uvm_test;
		cpm_regs_vendor_Cadence_Design_Systems_library_CPM_Registers_version_1_0 model;
		...
		virtual function void build_phase(uvm_phase phase);
			...
			model=cpm_regs_vendor_Cadence_Design_Systems_library_CPM_Registers_version_1_0::type_id::create("model", this);
			model.build();
			model.set_hdl_path_root("top.dut");
			model.cpm.set_auto_predict(1);
			model.cpm.set_sequencer(hi_uvc0.sqr,adapter);
			model.lock_model();
